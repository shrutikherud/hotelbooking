<div class="container-fluid bg-white mt-5">
  <div class="row">
    ...
    <div class="col-lg-4 p-4">
      ...
      <a href="rooms.php" class="d-inline-block mb-2 text-dark text-decoration-none">Hotels</a> <br>
...
<script>
  ...
  register_form.addEventListener('submit', (e)=>{
    ...
    data.append('aadhar',register_form.elements['aadhar'].value);
  ...
  login_form.addEventListener('submit', (e)=>{
    ...
    data.append('mob',login_form.elements['mob'].value);
