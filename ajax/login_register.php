<?php 
  ...
  if(isset($_POST['register']))
  {
    ...
    $u_exist = select("SELECT * FROM `user_cred` WHERE `phonenum` = ? LIMIT 1",
      [$data['phonenum']],"s");
    ...
    $values = [$data['name'],$data['phonenum'],$data['aadhar'],$data['address'],$data['pincode'],$data['dob'],
      $enc_pass];
